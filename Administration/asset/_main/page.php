...
switch ($page) {
	...
	case 'Register-Employe':
		...
		break;
	case 'Register-Employe-Upload-Without':
		include "registrasi_employe_upload_without_mask.php";
		break;
	case 'Register-Employe-Upload-With':
		include "registrasi_employe_upload_with_mask.php";
		break;
	case 'Data-Employe-Upload':
		include "data_employe_upload.php";
		break;
