...
class face_extractor:
    ...
    def __init__(self):
        ...
        self.face_cascade1 = cv2.CascadeClassifier(d + '/_lib/cascades/data/haarcascade_frontalface_alt2.xml')
        self.face_cascade2 = cv2.CascadeClassifier(d + '/_lib/cascades/data/haarcascade_frontalface_alt.xml')
        self.face_cascade3 = cv2.CascadeClassifier(d + '/_lib/cascades/data/haarcascade_profileface.xml')
        self.min_width = 2000
        self.min_height = 2000

        self.dir = d + r'/sys_tesis/asset/_upload/dataset'  # Set Images Folders Location, It will find images in all folders
