...
if (isset($_POST['submit'])) {
  ...
  for($x=0; $x<$jumlahFile; $x++){
    ...
    $file_name_new = uniqid('Wihtout-Mask-',true) .'.'. $imgExt;
    ...
    if (empty($fimage_name)) {
      ...
      if (!in_array($imgExt,$ekstensi)) {
        ...
        if ($user) {
          echo "<script>window.location.href='dasboard.php?page=Register-Employe-Upload-With&fid=".$fid."'</script>";
        }
      }
    }
  }
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Upload Images Tanpa Masker</h6>
                        </div>
                        <div class="card-body">
