    ...
    if (empty($fnik)) {
        ...
        try{
            ...
            if ($row['NIK'] == $fnik) {
                ...
                if (!empty($pushReg)) {
                    echo "<script>window.location.href='dasboard.php?page=Register-Employe-Upload-Without&fid=".$fnik."'</script>";
                    $pushAcces = $user->register_access($fnik,$fullname,$femail);
                }
            }
